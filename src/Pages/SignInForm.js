    ...
    render() {
        ...
        <div className="FormCenter">
            ...
            <div className="FormField">
                ...
                <input type="email" id="email" className="FormField__Input" placeholder="eg rebeccaadengbono2017@gmail.com" name="email" value={this.state.email} onChange={this.handleChange} />
              </div>
